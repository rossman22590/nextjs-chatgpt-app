...
// Use NEXT_PUBLIC_BRAND_TITLE to pull from environment variables at runtime
const brandTitle = process.env.NEXT_PUBLIC_BRAND_TITLE || 'Default Brand Title';
      ...
      <Box sx={{
        ...
        <Typography level='h1' sx={{ fontSize: '2.9rem', mb: 4 }}>
          ...
          <Box
            component='span'
            sx={{
              animation: `${animationColorBlues} 10s infinite`,
              zIndex: 1, // perf-opt
            }}
          >
            {firstNews?.versionCode}
          </Box>
          !
        </Typography>
