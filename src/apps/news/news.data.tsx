...
export const NewsItems: NewsItem[] = [
  // still unannounced: phone calls, split windows, ...
  {
    ...
    items: [
      { text: <><B href='#'>DALL·E 3</B> support (/draw), with advanced control</>, },
      { text: <><B href='#'>Perfect scrolling</B> UX, on all devices</>,  },
      { text: <>Create personas <B href='#'>from text</B></>,  },
  ...
  },
  {
    ...
    items: [
      { text: <><B href='#'>Google Gemini</B> models support</> },
      { text: <><B href='#'>Mistral Platform</B> support</> },
      { text: <><B href='#'>Ollama chats</B> perfection</> },
      { text: <>Custom <B href='#'>diagrams instructions</B> (@joriskalz)</> },
  ...
  },
  {
    ...
    items: [
      { text: <>Redesigned <B href='#'>attachments system</B>: drag, paste, link, snap, images, text, pdfs</> },
      ...
      { text: <><B href='#'>Overheat</B> LLMs with higher temperature limits</> },
  ...
  },
  {
    ...
    items: [
      { text: <><B href='#'>Web Browsing</B> support, see the <B href={RCode + '/docs/config-browse.md'}>browsing user guide</B></> },
      { text: <><B href='#'>Branching Discussions</B> at any message</> },
      { text: <><B href='#'>Keyboard Navigation</B>: use {platformAwareKeystrokes('Ctrl+Shift+Left/Right')} to navigate chats</> },
      { text: <><B href='#'>UI fixes</B> (thanks to the first sponsor)</> },
  ...
  },
  {
    ...
    items: [
      { text: <><B href='#'>Continued Voice</B> for hands-free interaction</> },
      { text: <><B href='#'>Visualization</B> Tool for data representations</> },
      { text: <><B href={RCode + '#'}>Ollama (guide)</B> local models support</> },
      { text: <><B href='#'>Text Tools</B> including highlight differences</> },
