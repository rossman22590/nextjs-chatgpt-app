...
export const NewsItems: NewsItem[] = [
  /*{
    ...
    items: [
      { text: <><B wow>o1-preview preview</B>o1-preview model</>, issue: 470, icon: ChatBeamIcon },
  ...
  },
  {
    ...
    items: [
      { text: <> Find better answers with multi-model AI reasoning</>, issue: 443, icon: ChatBeamIcon },
...
function B(props: {
  ...
  if (!href)
    return boldText;
  return (
    <Link href={href + clientUtmSource()} target='_blank' sx={  undefined}>
