...
import { Box, ButtonGroup, CircularProgress, Divider, IconButton, ListDivider, ListItemDecorator, MenuItem, Tooltip, Typography, useColorScheme } from '@mui/joy';
    ...
    >
      ...
      {!!opsMenuAnchor && (
        <ChatMessageMenu
          ...
          onOpsBeamFrom={(!onMessageBeam || process.env.NEXT_PUBLIC_BEAM === 'false') ? undefined : handleOpsBeamFrom}
          ...
          <ClickAwayListener onClickAway={handleBubbleClickAway}>
            ...
            >
              ...
              {onTextDiagram && <Tooltip disableInteractive arrow placement='top' title={couldDiagram ? 'Auto-Diagram...' : 'Too short to Auto-Diagram'}>
                <IconButton aria-label={couldDiagram ? 'Auto-diagram' : 'Auto-diagram (selection too short)'} color='success' onClick={couldDiagram ? handleOpsTextDiagram : undefined}>
              ...
              {onTextImagine && <Tooltip disableInteractive arrow placement='top' title='Auto-Draw'>
                <IconButton aria-label="Auto-draw" color='success' onClick={handleOpsTextImagine} disabled={!couldImagine || props.isImagining}>
              ...
              {onTextSpeak && <Tooltip disableInteractive arrow placement='top' title='Speak'>
                <IconButton aria-label="Speak" color='success' onClick={handleOpsTextSpeak} disabled={!couldSpeak || props.isSpeaking}>
