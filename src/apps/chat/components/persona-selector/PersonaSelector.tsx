  ...
  return (
    <Box
      ...
      sx={{
        ...
        ...(isActiveCard ? {
          background: 'linear-gradient(145deg, var(--joy-palette-primary-solidBg) 0%, var(--joy-palette-primary-solidHoverBg) 55%, var(--joy-palette-primary-softColor) 100%)',
          ...
          border: '1.5px solid var(--joy-palette-primary-outlinedBorder)',
          color: 'var(--joy-palette-text-primary)',
          '&:hover': {
            background: 'var(--joy-palette-primary-softHoverBg)',
            borderColor: 'var(--joy-palette-primary-softActiveBg)',
            transform: 'translateY(-3px)',
            boxShadow: 'var(--joy-shadow-sm)',
          },
          '&:active': { transform: 'translateY(-1px)' },
          '&:focus-visible': { outline: '2px solid rgba(var(--joy-palette-primary-mainChannel) / 0.5)', outlineOffset: 2 },
        } : {
          ...
          '&:hover': {
            background: 'var(--joy-palette-primary-softBg)',
            borderColor: 'rgba(var(--joy-palette-primary-mainChannel) / 0.28)',
            transform: 'translateY(-3px)',
            boxShadow: 'var(--joy-shadow-sm)',
          },
          '&:active': { transform: 'translateY(-1px)' },
