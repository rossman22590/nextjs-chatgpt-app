...
export function AppChat() {
  ...
  useGlobalShortcuts('AppChat', React.useMemo(() => [
    ...
    ...(process.env.NEXT_PUBLIC_BEAM === 'false' ? [] : [{ key: 'b', ctrl: true, shift: true, disabled: isFocusedChatEmpty, action: handleMessageBeamLastInFocusedPane, description: 'Beam Edit' }]),
