...
const orOldModelIDs = [
  ...
  'anthropic/claude-instant-v1-100k', 'anthropic/claude-v1-100k', 'sophosympatheia/midnight-rose-70b' ,'anthropic/claude-instant-1.0',
];
...
const orModelFamilyOrder = [
  ...
  // great orgs
  'huggingfaceh4/', 'openchat/', 'anthropic/', 'google/', 'mistralai/', 'openai/', 'meta-llama/', 'phind/', 'perplexity/'
];
