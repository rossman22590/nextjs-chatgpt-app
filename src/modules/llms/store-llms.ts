...
const defaultChatSuffixPreference = ['gpt-4-1106-preview', 'gpt-3.5-turbo'];
...
const defaultFuncSuffixPreference = ['gpt-4-1106-preview', 'gpt-3.5-turbo-16k-0613', 'gpt-3.5-turbo-0613'];
