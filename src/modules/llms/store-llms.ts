...
const defaultChatSuffixPreference = ['gpt-4-turbo-preview', 'gpt-4-0613', 'gpt-4', 'gpt-4-32k', 'gpt-3.5-turbo'];
...
const defaultFuncSuffixPreference = ['gpt-4-turbo-preview', 'gpt-3.5-turbo-16k-0613', 'gpt-3.5-turbo-0613', 'gpt-4-0613'];
