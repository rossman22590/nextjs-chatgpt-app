 ...
 */
function _forwardCodeInterpreterCallItem(pt: IParticleTransmitter, codeInterpreterCall: Extract<OpenAIWire_API_Responses.ResponsesAPIResponse['output'][number], { type: 'code_interpreter_call' }>): void {
 ...
 */
function _forwardCustomToolCallItem(pt: IParticleTransmitter, customToolCall: Extract<OpenAIWire_API_Responses.ResponsesAPIResponse['output'][number], { type: 'custom_tool_call' }>): void {
