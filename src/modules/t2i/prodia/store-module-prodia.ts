...
// These resolutions work well for SDXL models, per the Prodia documentation.
...
export const useProdiaStore = create<ModuleProdiaStore>()(
  persist(
    (set) => ({
      ...
      prodiaSeed: null,
      setProdiaSeed: (prodiaSeed: string) =>
        set({ prodiaSeed: (prodiaSeed === '' || prodiaSeed === '-1') ? null : parseInt(prodiaSeed) ?? null }),
    }),
    {
