---
name: "source-command-llms-update-models-alibaba"
description: "Update Alibaba model definitions with latest pricing and capabilities"
---

# source-command-llms-update-models-alibaba

Use this skill when the user asks to run the migrated source command `llms-update-models-alibaba`.
