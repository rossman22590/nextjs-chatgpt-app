---
name: "source-command-llms-align-params-uis"
description: "Sync LLM parameter options between full model dialog and chat side panel"
---

# source-command-llms-align-params-uis

Use this skill when the user asks to run the migrated source command `llms-align-params-uis`.
