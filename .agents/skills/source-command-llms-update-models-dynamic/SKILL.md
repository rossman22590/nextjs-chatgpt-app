---
name: "source-command-llms-update-models-dynamic"
...
# source-command-llms-update-models-dynamic

Use this skill when the user asks to run the migrated source command `llms-update-models-dynamic`.
