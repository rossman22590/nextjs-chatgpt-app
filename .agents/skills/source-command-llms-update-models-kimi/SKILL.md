---
name: "source-command-llms-update-models-kimi"
description: "Update Kimi model definitions with latest pricing and capabilities"
---

# source-command-llms-update-models-kimi

Use this skill when the user asks to run the migrated source command `llms-update-models-kimi`.
