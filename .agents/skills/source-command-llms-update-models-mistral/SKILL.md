---
name: "source-command-llms-update-models-mistral"
description: "Update Mistral model definitions with latest pricing and capabilities"
---

# source-command-llms-update-models-mistral

Use this skill when the user asks to run the migrated source command `llms-update-models-mistral`.
