---
name: "source-command-llms-update-models-groq"
description: "Update Groq model definitions with latest pricing and capabilities"
---

# source-command-llms-update-models-groq

Use this skill when the user asks to run the migrated source command `llms-update-models-groq`.
