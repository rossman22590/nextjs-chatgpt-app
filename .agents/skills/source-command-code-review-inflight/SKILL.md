---
name: "source-command-code-review-inflight"
description: "Review in-flight changes for coherence, completeness, and quality"
---

# source-command-code-review-inflight

Use this skill when the user asks to run the migrated source command `code-review-inflight`.
