---
name: "source-command-code-thread-progress"
description: "Show a hierarchical progress tree of the current conversation thread"
---

# source-command-code-thread-progress

Use this skill when the user asks to run the migrated source command `code-thread-progress`.
