---
name: "source-command-llms-update-models-ollama"
description: "Update Ollama model definitions with latest featured models"
---

# source-command-llms-update-models-ollama

Use this skill when the user asks to run the migrated source command `llms-update-models-ollama`.
...
node .Codex/scripts/parse-ollama-models.js 2>&1
```
...
- Parser script: `.Codex/scripts/parse-ollama-models.js`
