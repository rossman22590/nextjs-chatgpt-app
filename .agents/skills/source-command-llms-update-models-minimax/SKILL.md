---
name: "source-command-llms-update-models-minimax"
description: "Update MiniMax model definitions with latest pricing and capabilities"
---

# source-command-llms-update-models-minimax

Use this skill when the user asks to run the migrated source command `llms-update-models-minimax`.
