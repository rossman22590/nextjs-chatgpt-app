---
name: "source-command-llms-update-models-gemini"
description: "Update Gemini model definitions with latest pricing and capabilities"
---

# source-command-llms-update-models-gemini

Use this skill when the user asks to run the migrated source command `llms-update-models-gemini`.
