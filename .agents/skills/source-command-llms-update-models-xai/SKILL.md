---
name: "source-command-llms-update-models-xai"
description: "Update xAI model definitions with latest pricing and capabilities"
---

# source-command-llms-update-models-xai

Use this skill when the user asks to run the migrated source command `llms-update-models-xai`.
