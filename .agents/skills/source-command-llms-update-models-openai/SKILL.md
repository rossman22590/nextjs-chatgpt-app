---
name: "source-command-llms-update-models-openai"
description: "Update OpenAI model definitions with latest pricing and capabilities"
---

# source-command-llms-update-models-openai

Use this skill when the user asks to run the migrated source command `llms-update-models-openai`.
