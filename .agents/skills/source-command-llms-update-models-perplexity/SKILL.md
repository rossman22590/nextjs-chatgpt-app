---
name: "source-command-llms-update-models-perplexity"
description: "Update Perplexity model definitions with latest pricing and capabilities"
---

# source-command-llms-update-models-perplexity

Use this skill when the user asks to run the migrated source command `llms-update-models-perplexity`.
